...
import io.mock.aws.sqsmock.messages.{ErrorResponse, SendMessageBatchResponse, SendMessageResponse}
import io.mock.aws.sqsmock.model.{Message, MessageBatchEntry, QueueCache}
